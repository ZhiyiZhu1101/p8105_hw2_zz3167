...
- There are 487 observations (each id has 5 rows) and 3 variables in the
  dataset `amyloid_df`. The names of variables are: id,
  years_since_baseline, amyloid_ratio.
