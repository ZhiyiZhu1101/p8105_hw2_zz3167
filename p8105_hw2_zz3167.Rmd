...
* There are `r nrow(amyloid_df)/5` observations (each id has 5 rows) and `r ncol(amyloid_df)` variables in the dataset `amyloid_df`. The names of variables are: `r names(amyloid_df)`.
