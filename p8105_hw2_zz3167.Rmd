...
* `r round(nrow(subset(filter_baseline_df, sex == "female" & apoe4 == "APOE4 carrier"))/nrow(subset(baseline_df, sex == "female"))*100, digits = 2)`% women in the study are APOE4 carrier.
